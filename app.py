...
DAILY_DILEMMAS_TIME = os.getenv('DAILY_DILEMMAS_TIME', '11:44')
load_dotenv()
...
def read_phone_numbers(file_name):
    with open(file_name, 'r', encoding='utf-8') as file:
        ...
        print(f"Phone numbers read from file: {phone_numbers}")
...
def send_dilemma(phone_number):
    ...
    print(f'Sent dilemma to {phone_number}')
